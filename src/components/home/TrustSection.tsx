    ...
    return (
        <section className="py-20 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="relative flex flex-col overflow-hidden mask-gradient">
                    <div className="flex animate-marquee whitespace-nowrap space-x-12 items-center hover:pause no-scrollbar">
